...
<li class="breadcrumb-item"><a>Manage Pass</a>
</li>
<li class="breadcrumb-item"><a href="pass.php">Pass</a>
</li>
</ul>
</div>
</div>
...
<div class="card-header">
    <div class="col-sm-10">
        <a href="addpass.php"><button class="btn btn-primary pull-right">+ Add Pass</button></a>
    </div>
