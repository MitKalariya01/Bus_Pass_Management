...
<div class="col-sm-4">
<input type="text" class="form-control" name="business_name" id="business_name" placeholder="Enter Company Name" required="">
<span class="messages"></span>
</div>
<label class="col-sm-2 col-form-label">Company Email</label>
<div class="col-sm-4">
<input type="text" class="form-control" name="business_email" id="business_email" placeholder="Enter Company Email" required="">
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" class="form-control" name="curr_sym" id="curr_sym" placeholder="Enter Currency" required="">
<span class="messages"></span>
</div>
...
<div class="col-sm-4">
<input type="text" class="form-control" name="def_tax" id="def_tax" placeholder="Enter Tax" required="">
<span class="messages"></span>
</div>
